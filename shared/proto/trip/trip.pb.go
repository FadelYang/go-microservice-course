...
type TripDriver struct {
	...
	ProfilePictuire string                 `protobuf:"bytes,3,opt,name=profilePictuire,proto3" json:"profilePictuire,omitempty"`
...
func (x *TripDriver) GetProfilePictuire() string {
	if x != nil {
		return x.ProfilePictuire
	}
	return ""
}
...
const file_trip_proto_rawDesc = "" +
	...
	"\x0fprofilePictuire\x18\x03 \x01(\tR\x0fprofilePictuire\x12\x1a\n" +
